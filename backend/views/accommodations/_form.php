...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            foreach ($model::GetAccommodationsFeatures(null) as $key => $feature) {
    ...
    <div class="col-md-12">
        ...
        echo FileInput::widget([
            ...
            'pluginOptions' => [
                ...
                'uploadExtraData' => ['folder' => 'accommodations'],
            ]
        ]);
        ?>
    </div>

...
<div id="video-gallery">
    <?php foreach ($gallery->videos as $index => $video): ?>
        ...
        <li class="col-xs-12 col-sm-4 col-md-4" data-poster="https://img.youtube.com/vi/' . ltrim(strstr($video->video, 'v='), 'v=') . '/maxresdefault.jpg" data-src="' . $video->video . '" data-sub-html=".video-desc">
